...
if [ -d .git ]; then
  ...
  case "$origin" in
    *netbox-community/netbox*) info "In a clone of netbox-community/netbox." ;;
    "") warn "This git repo has no origin; check you are in netbox-community/netbox." ;;
    *) warn "This looks like $origin, not netbox-community/netbox. The commands below assume the latter." ;;
  esac
else
